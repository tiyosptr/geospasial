    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View>
          ...
          <Text style={styles.title}>Jumlah Rumah Susun Sewa Pemerintah</Text>
            ...
            {/* <MapComponent
              ...
              onPoiLongPress={
                (name, latitude, longitude) =>
                  console.log(name, latitude, longitude) // Menangani event long press pada POI (point of interest)
              }
            /> */}
          </View>
          <View style={styles.dropdownContainer}>
            ...
            <Text style={styles.totalText}>
              Total: {filteredPerumahan.length} Rumah Susun Sewa Pemerintah di Seluruh Kota Batam
            </Text>
          </View>
